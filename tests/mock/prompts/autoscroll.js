export const scroll_prompt   = `I declare I don't care no more`
export const scroll_reply    = `I'm burning up and out and growing bored`

export const scroll_prompt_2 = `The world is my expense`
export const scroll_reply_2  = `The cost of my desire
